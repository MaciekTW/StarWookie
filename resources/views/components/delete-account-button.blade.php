<label class="w-36 flex flex-col items-center mx-3 py-3 bg-white text-black rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-rose-600 hover:border-current hover:text-white">
